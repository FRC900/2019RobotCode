...
{
	ros::init(argc, argv, "align_cargo_rocketship_server");
	...
	if(!n_private_params.getParam("debug", debug))
		ROS_ERROR_STREAM("Could not read debug in align_cargo_rocketship_server");

	AlignCargoRocketshipAction align_cargo_rocketship_action("align_cargo_rocketship_server",
			"align_cargo_rocketship_pid/pid_enable",
			"navX_pid/pid_enable",
